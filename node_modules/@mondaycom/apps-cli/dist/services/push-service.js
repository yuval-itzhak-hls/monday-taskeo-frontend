...
import { compressBuildToZip, createTarGzArchive, readFileData, readZipFileAsBuffer, verifyClientDirectory, } from './files-service.js';
...
export const getSignedStorageUrl = async (appVersionId, region) => {
...
export const getAppVersionDeploymentStatus = async (appVersionId, region) => {
    try {
...
export const pollForDeploymentStatus = async (appVersionId, retryAfter, region, options = {}) => {
