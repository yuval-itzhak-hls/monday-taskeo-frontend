...
import { validateIfCanBuild } from '../../services/files-service.js';
...
export default class Push extends AuthenticatedCommand {
    ...
    static flags = Push.serializeFlags(addRegionToFlags({
    ...
    static args = {};
    DEBUG_TAG = 'code_push';
    async handleCdnUpload(appVersionId, directoryPath) {
