...
import { cloneAppTemplateAndLoadManifest, createApp, createFeatures } from '../../services/apps-service.js';
import { DynamicChoicesService } from '../../services/dynamic-choices-service.js';
import { PromptService } from '../../services/prompt-service.js';
import logger from '../../utils/logger.js';
import { getLastParam } from '../../utils/urls-builder.js';
export default class AppCreate extends AuthenticatedCommand {
    ...
    async run() {
        try {
            ...
            logger.success(`Your app is ready, 'cd ${getLastParam(tasks.ctx.targetPath)}' to see your app files. \n` +
