...
var menuPortalCSS = function(_ref6) {
  ...
  return _createClass(MenuPortal, [ {
    ...
    value: function() {
      ...
      var placement = this.state.placement || coercePlacement(menuPlacement), rect = getBoundingClientObj(controlElement), scrollDistance = isFixed ? 0 : window.pageYOffset, offset = rect[placement] + scrollDistance, menuWrapper = jsx("div", {
...
var jsx$1 = emotionCore.jsx, containerCSS = function(_ref) {
...
var jsx$2 = emotionCore.jsx, keyframes = emotionCore.keyframes, Svg = function(_ref) {
...
}, baseCSS = function(_ref2) {
  var isFocused = _ref2.isFocused, _ref2$theme = _ref2.theme, baseUnit = _ref2$theme.spacing.baseUnit, colors = _ref2$theme.colors;
  return {
...
}, indicatorSeparatorCSS = function(_ref3) {
  var isDisabled = _ref3.isDisabled, _ref3$theme = _ref3.theme, baseUnit = _ref3$theme.spacing.baseUnit, colors = _ref3$theme.colors;
  return {
...
}, loadingDotAnimations = keyframes(_templateObject()), loadingIndicatorCSS = function(_ref4) {
  var isFocused = _ref4.isFocused, size = _ref4.size, _ref4$theme = _ref4.theme, colors = _ref4$theme.colors, baseUnit = _ref4$theme.spacing.baseUnit;
  return {
...
}, LoadingDot = function(_ref5) {
  var delay = _ref5.delay, offset = _ref5.offset;
  return jsx$2("span", {
    css: {
...
var jsx$3 = emotionCore.jsx, css = function(_ref) {
...
var jsx$4 = emotionCore.jsx, groupCSS = function(_ref) {
...
var jsx$5 = emotionCore.jsx, inputCSS = function(_ref) {
  ...
  _objectWithoutProperties(_ref2, [ "className", "cx", "getStyles", "innerRef", "isHidden", "isDisabled", "theme", "selectProps" ])), AutosizeInputComponent = AutosizeInput.default ? AutosizeInput.default : AutosizeInput;
  return jsx$5("div", {
...
var jsx$6 = emotionCore.jsx, ClassNames = emotionCore.ClassNames, multiValueCSS = function(_ref) {
...
var jsx$7 = emotionCore.jsx, optionCSS = function(_ref) {
...
}, jsx$8 = emotionCore.jsx, placeholderCSS = function(_ref) {
...
}, jsx$9 = emotionCore.jsx, css$1 = function(_ref) {
  var isDisabled = _ref.isDisabled, _ref$theme = _ref.theme, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
  return {
    label: "singleValue",
