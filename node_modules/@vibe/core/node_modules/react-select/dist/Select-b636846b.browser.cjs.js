...
var emotionCore = require('@emotion/core');
var reactDom = require('react-dom');
var index = require('./index-2e6d22c8.browser.cjs.js');
...
var jsx = emotionCore.jsx; // Assistive text to describe visual elements. Hidden for sighted users.
...
var jsx$2 = emotionCore.jsx; // NOTE:
...
var ScrollBlock = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ScrollBlock, [{
    ...
    value: function render() {
      ...
      return jsx$2("div", null, jsx$2("div", {
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.buildMenuOptions = memoizeOne(_this.buildMenuOptions, function (newArgs, lastArgs) {
      var _newArgs = _slicedToArray(newArgs, 2),
          newProps = _newArgs[0],
          newSelectValue = _newArgs[1];

      var _lastArgs = _slicedToArray(lastArgs, 2),
          lastProps = _lastArgs[0],
          lastSelectValue = _lastArgs[1];
